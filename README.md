# Clon del Dark Echo — Prototipo Web v0.61
...
- **Jugador** representado como punto blanco (radio 3px)
  ...
  - Sin ondas durante deslizamiento por pared; destino cancelado tras 0.8s de slide sin avance real
  - **Dirección de mirada**: se actualiza automáticamente con cada desplazamiento real (calculada sobre el vector de movimiento, no sobre el vector al target); visualizada como línea corta desde el jugador
- **Lanzar piedra** (botón PIEDRA, cooldown 7s): vuela en la dirección de mirada hasta chocar con una pared o recorrer 12 celdas; emite una onda de impacto **amarilla** que alerta a los enemigos cercanos sin delatar al jugador
